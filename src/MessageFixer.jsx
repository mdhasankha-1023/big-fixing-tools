...
const MessageFixer = () => {
    ...
    const detectBugs = () => {
        ...
        const countBadWords = highlighted.flat().filter((item) => item.isBad).length;
    ...
    return (
        <div className="w-[60%] mt-10 p-4 mx-auto">
            <h1 className="text-[50px] font-semibold text-center mb-6">BUG FIXING TOOLS (V2.0)</h1>
